...
public final class FragmentNotesBinding implements ViewBinding {
  ...
  private FragmentNotesBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView notesList,
  ...
  public static FragmentNotesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentNotesBinding((ConstraintLayout) rootView, notesList, progress);
    }
